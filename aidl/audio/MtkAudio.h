...
#include <aidl/vendor/mediatek/hardware/audio/IAudioParameterChangedCallback.h>
#include <aidl/vendor/mediatek/hardware/audio/Result.h>
...
public:
    ...
    ndk::ScopedAStatus clearAudioParameterChangedCallback(
            int32_t cbkKey,
            Result* pResult) override;
};
